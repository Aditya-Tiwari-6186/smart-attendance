...
# Connect to MongoDB
client = MongoClient("mongodb+srv://ujjwalchauhan654:REALMEX7@cluster0.k92z0.mongodb.net/Attendance")
...
duration_seconds = 7  # Capture duration
...
export()
print("🛑 Capture stopped after 20 seconds.")
